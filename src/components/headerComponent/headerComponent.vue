    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li>
            <a class="nav-link scrollto" href="/#portfolio">Our Services</a>
          </li>
          <li><a class="nav-link" href="/our-journey">Our Journey</a></li>
          <li><a class="nav-link scrollto" href="/#contact">Contact</a></li>
          <li>
            <a class="getstarted scrollto" href="/support-us">Support Us</a>
          </li>
        </ul>
